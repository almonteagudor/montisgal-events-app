...
import { MenuService } from '../services/super-admin.menu.service';
...
export class SuperAdminMenuitemComponent implements OnInit, OnDestroy {
    ...
    constructor(public layoutService: SuperAdminLayoutService, private cd: ChangeDetectorRef, public router: Router, private menuService: MenuService) {
